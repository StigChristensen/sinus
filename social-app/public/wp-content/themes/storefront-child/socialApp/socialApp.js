...
var userFeed = function userFeed() {
  ...
  var ImageFeed = _react2.default.createClass({
    displayName: 'ImageFeed',

    render: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'image-nodes' },
        this.props.data.map(function (image) {
          return _react2.default.createElement(Image, { key: image.id,
            id: image.id,
    ...
    render: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('img', { className: 'feed-thumb', src: this.props.thumb })
        ),
        _react2.default.createElement(
          'div',
          { className: 'like-bar' },
          _react2.default.createElement('img', { className: 'like-icon', src: '/img/like.png' }),
          _react2.default.createElement(
            'p',
            { className: 'likes' },
            this.props.likes
          ),
          _react2.default.createElement('img', { className: 'comments-icon', src: '/img/comments.png' }),
          _react2.default.createElement(
            'p',
            { className: 'comments' },
            this.props.comments
...
},{"react":159,"react-dom":3}],161:[function(require,module,exports){
'use strict';
...
var userFeed = require('./components/userFeed.js');

new userInfo();
new userFeed();

},{"../../node_modules/jquery/dist/jquery.min.js":2,"./components/userFeed.js":160,"./components/userInfo.js":161}]},{},[162])


//# sourceMappingURL=maps/socialApp.js.map
