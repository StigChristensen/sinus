...
class WC_QuickPay_Swipp extends WC_QuickPay_Instance {
    ...
    public function __construct() {
        ...
        $this->method_title = 'QuickPay - Swipp';
        ...
        add_filter( 'woocommerce_quickpay_cardtypelock_swipp', array( $this, 'filter_cardtypelock' ) );
    }
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => __( 'Enable Swipp payment', 'woo-quickpay' ),
                'default' => 'no'
            ),
            '_Shop_setup' => array(
                'type' => 'title',
