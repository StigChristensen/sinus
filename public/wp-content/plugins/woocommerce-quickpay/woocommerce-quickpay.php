...
function init_quickpay_gateway()
{
    ...
    require_once('classes/woocommerce-quickpay-countries.php');
    require_once('classes/woocommerce-quickpay-views.php');
    ...
    class WC_QuickPay extends WC_Payment_Gateway
    {
        ...
        public static function filter_load_instances($methods)
        {
            ...
            require_once('classes/instances/klarna.php');
            require_once('classes/instances/swipp.php');
            require_once('classes/instances/sofort.php');

            $methods[] = 'WC_QuickPay_MobilePay';
            $methods[] = 'WC_QuickPay_ViaBill';
            $methods[] = 'WC_QuickPay_Klarna';
            $methods[] = 'WC_QuickPay_Swipp';
                                ...
                                if (!empty($subscription_id)) {
                                    ...
                                    $subscription->note(sprintf(__('Subscription authorized. Transaction ID: %s', 'woo-quickpay'), $json->id));
                                        ...
                                        if ($subscription_initial_payment > 0) {
                                            ...
                                            if (!WC_QuickPay_Subscription::is_subscription($order->id) && $order->contains_subscription()) {
