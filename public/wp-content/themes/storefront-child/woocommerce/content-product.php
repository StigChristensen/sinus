...
<li <?php post_class( $classes ); ?> itemscope itemtype="http://schema.org/Product">
	...
	<a href="<?php the_permalink(); ?>">
		...
		?>
			<div class="add-button" data-href="<?php echo $product->id; ?>" data-title="<?php do_action( 'woocommerce_shop_loop_item_title' ); ?>">
				...
				<span class="add-info">Tilføj til kurv</span>

			</div>
		</div>

		<div class="sinus-product-info">
			...
			<div class="short-desc" itemprop="description">
				...
				<span class="mere">Klik for mere info</span>
			</div>
	</div>
