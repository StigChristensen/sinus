...
<div class="om-os-container">
  ...
  <div class="headline"><h1>Om os</h1></div>
  ...
  <div class="page-element">
    ...
    <div class="om-os-text">
      <h3>Sinus er Danmarks mest specialiserede forretning indenfor hovedtelefoner og transportabel lyd</h3>
          <p class="paragraph">Vi har i takt med den teknologiske udvikling nået et punkt hvor hovedparten af den musik vi hører i løbet af en dag, lyttes til igennem vores hovedtelefoner. Og vi mener at musikken i dit liv fortjener god lyd.<br>
